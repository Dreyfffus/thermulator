...
: ${AMENT_CURRENT_PREFIX:="/ws/install/thermocator"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/thermocator/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/thermocator/environment/path.sh"
